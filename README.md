...
Swagger permettant de decrire ce qui est consomme par le front et produit par notre API, nous l'avons utilise comme [Spec](https://github.com/kh42z/p42ng/blob/master/srcs/public/swagger/swagger.yaml). Theoriquement le front/back pouvaient s'accorder sur le comportement de l'API avant son implementation.
